...
class ValidateJsonApiHeadersTest extends TestCase
{
    ...
    public function test_content_type_must_be_present_in_all_post_requests()
    {
    ...
    public function test_content_type_must_be_present_in_all_patch_requests()
    {
    ...
    public function test_content_type_header_must_not_be_present_in_empty_responses()
    {
